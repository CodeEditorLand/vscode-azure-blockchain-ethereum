	...
	render() {
		return (
			<Card className="ui transaction section">
				...
				<div className="text">
					All transactions (deployed contracts and function
					executions) in this environment can be saved and replayed in
					another environment. e.g Transactions created in Javascript
