...
export class TransactionNodeResource {
	...
	public getTransactionNode(
		...
		return new Promise((resolve, reject) => {
			return this.client.getTransactionNode(
				memberName,
				transactionNodeName,
				(error: Error | null, result?: any) => {
					if (error) {
	...
	public getTransactionNodeAccessKeys(
		memberName: string,
		nodeName: string,
	): Promise<IAzureMemberAccessKeysDto> {
		return new Promise((resolve, reject) => {
