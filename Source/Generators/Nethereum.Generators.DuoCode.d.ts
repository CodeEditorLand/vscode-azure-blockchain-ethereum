...
declare namespace Nethereum {
	namespace Generators {
		...
		namespace Core {
			...
			export interface ParameterABIModel
				extends ParameterModel$1<Model.ParameterABI> {
				GetPropertyName$1(
			...
			export interface ABITypeToDotNetTypeBase
			...
			export interface ITypeConvertor {
				Nethereum$Generators$Core$ITypeConvertor$Convert(
					typeName: string,
			...
			export interface MessageMap$4TypeFunc<MFrom, MTo, PFrom, PTo>
				...
				new (
					from: MFrom,
					to: MTo,
					parameterMaps: System.Collections.Generic.List$1<
						ParameterMap$2<PFrom, PTo>
					>,
			...
			export interface MultipleClassGeneratorBase$2<
			...
			export interface MultipleClassGeneratorBase$2TypeFunc<
				...
				TMultipleClassFileModel,
			> extends TypeFunction {
				(): MultipleClassGeneratorBase$2TypeFunc<
					TMultipleClassFileTemplate,
					TMultipleClassFileModel
				>;
			...
			export interface TypeMessageModel
				extends System.Object,
					IClassModel,
					IFileModel {
				get_Namespace(): string;
			...
			export interface WorkflowGeneratorBase$2<
				TWorkflowTemplate,
				TWorkflowModel,
			> extends System.Object,
			...
			export interface WorkflowGeneratorBase$2TypeFunc<
				...
				TWorkflowModel,
			> extends TypeFunction {
				(): WorkflowGeneratorBase$2TypeFunc<
					TWorkflowTemplate,
					TWorkflowModel
				>;
			...
			export interface WorkflowTemplateBase$1<TModel>
				extends System.Object,
					IWorkflowTemplate {
				GenerateWorkflow(): string;
				GenerateFullWorkflow(): string;
			...
			export interface WorkflowTypeMessageModel
				extends System.Object,
					IWorkflowModel,
					IFileModel {
				get_Namespace(): string;
		...
		namespace Service {
			...
			export interface AllMessagesGenerator
				extends Core.MultipleClassGeneratorBase$2<
						CQS.MultipleClassFileTemplate,
						AllMessagesModel
					>,
					Core.IFileGenerator,
					Core.IGenerator {
			...
			export interface AllMessagesModel
				extends Core.FileModel,
					Core.IFileModel {
			...
			export interface ServiceGenerator
				extends Core.ClassGeneratorBase$2<
						CQS.ClassTemplateBase$1<ServiceModel>,
						ServiceModel
					>,
					Core.IFileGenerator,
					Core.IGenerator,
			...
			export interface ContractDeploymentServiceMethodsCSharpTemplate
				extends System.Object {
			...
			export interface ContractDeploymentServiceMethodsFSharpTemplate
				extends System.Object {
				GenerateMethods(): string;
			}
			...
			export interface ContractDeploymentServiceMethodsVbTemplate
				extends System.Object {
				GenerateMethods(): string;
			}
		...
		namespace CQS {
			...
			export interface ClassTemplateBase$1<TModel>
				extends System.Object,
					Core.IClassTemplate {
				GenerateClass(): string;
				GenerateFullClass(): string;
			...
			export interface FunctionCQSMessageGenerator
				extends Core.ClassGeneratorBase$2<
						ClassTemplateBase$1<FunctionCQSMessageModel>,
			...
			export interface FunctionCQSMessageModel
				extends Core.TypeMessageModel,
					Core.IClassModel,
					Core.IFileModel {
				get_FunctionABI(): Model.FunctionABI;
		...
		namespace DTOs {
			...
			export interface EventDTOGenerator
				extends Core.ClassGeneratorBase$2<
						CQS.ClassTemplateBase$1<EventDTOModel>,
						EventDTOModel
					>,
					Core.IFileGenerator,
					Core.IGenerator,
			...
			export interface EventDTOModel
				extends Core.TypeMessageModel,
					Core.IClassModel,
					Core.IFileModel {
				get_EventABI(): Model.EventABI;
			...
			export interface FunctionOutputDTOGenerator
				extends Core.ClassGeneratorBase$2<
						CQS.ClassTemplateBase$1<FunctionOutputDTOModel>,
			...
			export interface FunctionOutputDTOModel
				extends Core.TypeMessageModel,
					Core.IClassModel,
					Core.IFileModel {
				get_FunctionABI(): Model.FunctionABI;
			...
			export interface EventDTOCSharpTemplate
			...
			export interface EventDTOVbTemplate
				extends CQS.ClassTemplateBase$1<EventDTOModel>,
					Core.IClassTemplate {
				GetPartialMainClass(): string;
			}
		...
		namespace ReportingWorkflow {
			...
			export interface ReportingWorkflowGeneratorTypeFunc
				extends TypeFunction {
			...
			export interface ReportingWorkflowModelTypeFunc
				extends TypeFunction {
			...
			export interface ReportingWorkflowTemplate
				extends Core.WorkflowTemplateBase$1<ReportingWorkflowModel>,
					Core.IWorkflowTemplate {}
			export interface ReportingWorkflowTemplateTypeFunc
				extends TypeFunction {
				...
				ctor: {
					new (
						model: ReportingWorkflowModel,
					): ReportingWorkflowTemplate;
				};
			}
		...
		namespace ServiceWorkflow {
			...
			namespace FlowApps {
				...
				export interface ServiceWorkflowParameterABIFunctionFlowAppTemplate
					extends System.Object {
			...
			namespace LogicApps {
				...
				export interface ServiceWorkflowParameterABIFunctionLogicAppTemplate
					extends System.Object {
					GenerateAllProperties(
						parameters: Model.ParameterABI[],
					): string;
		...
		namespace XUnit {
			...
			export interface SimpleTestGenerator
				extends Core.ClassGeneratorBase$2<
						CQS.ClassTemplateBase$1<SimpleTestModel>,
						SimpleTestModel
					>,
					Core.IFileGenerator,
					Core.IGenerator,
			...
			export interface SimpleTestModel
				extends Core.TypeMessageModel,
					Core.IClassModel,
					Core.IFileModel {
				get_ContractABI(): Model.ContractABI;
