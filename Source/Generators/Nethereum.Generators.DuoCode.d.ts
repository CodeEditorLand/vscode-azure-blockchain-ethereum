	...
	module Generators {
		...
		module ReportingWorkflow {
			...
			module FlowApps {
				...
				export interface ReportingWorkflowEventsOutputFlowAppGenerator
					extends Core.WorkflowGeneratorBase$2<
							Core.WorkflowTemplateBase$1<ReportingWorkflowEventFlowAppModel>,
							ReportingWorkflowEventFlowAppModel
						>,
						Core.IWorkflowFileGenerator,
						Core.IWFGenerator,
				...
				export interface ReportingWorkflowEventsOutputFlowAppTemplate
