...
try {
	const hdwalletNodeModulePath = path.join(
		process.cwd(),
		"node_modules",
		"truffle-hdwallet-provider",
	);
	require(hdwalletNodeModulePath);
	require.cache[require.resolve(hdwalletNodeModulePath)].exports =
...
const message = JSON.stringify(truffleConfig, getCircularReplacer());
