...
ItemFactory.register(
	ItemType.TRANSACTION_NODE,
	new TransactionNodeItemCreator(),
);
ItemFactory.register(
	ItemType.AZURE_CONSORTIUM,
	new AzureConsortiumItemCreator(),
);
ItemFactory.register(
	ItemType.LOCAL_CONSORTIUM,
	new LocalNetworkConsortiumItemCreator(),
);
ItemFactory.register(
	ItemType.ETHEREUM_TEST_CONSORTIUM,
	new TestNetworkConsortiumItemCreator(),
);
ItemFactory.register(
	ItemType.ETHEREUM_MAIN_CONSORTIUM,
	new MainNetworkConsortiumItemCreator(),
);
