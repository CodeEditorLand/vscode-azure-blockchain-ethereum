...
ItemFactory.register(
	...
	new AzureBlockchainServiceItemCreator(),
);
...
ItemFactory.register(
	...
	new BlockchainDataManagerServiceItemCreator(),
);

ItemFactory.register(
	ItemType.AZURE_BLOCKCHAIN_PROJECT,
	new AzureBlockchainProjectItemCreator(),
);
...
ItemFactory.register(
	...
	new BlockchainDataManagerProjectItemCreator(),
);

ItemFactory.register(
	ItemType.AZURE_BLOCKCHAIN_NETWORK_NODE,
	new AzureBlockchainNetworkNodeItemCreator(),
);
ItemFactory.register(
	ItemType.LOCAL_NETWORK_NODE,
	new LocalNetworkNodeItemCreator(),
);
ItemFactory.register(
...
ItemFactory.register(
	...
	new BlockchainDataManagerNetworkNodeItemCreator(),
);
ItemFactory.register(
