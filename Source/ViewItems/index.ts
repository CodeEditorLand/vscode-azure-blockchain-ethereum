...
ViewItemFactory.register(
	ItemType.ETHEREUM_TEST_NETWORK,
	new NetworkViewCreator(),
);
ViewItemFactory.register(
	ItemType.ETHEREUM_MAIN_NETWORK,
	new NetworkViewCreator(),
);
ViewItemFactory.register(
	ItemType.AZURE_CONSORTIUM,
	new ConsortiumViewCreator(),
);
ViewItemFactory.register(
...
ViewItemFactory.register(
	...
	new TransactionNodeViewCreator(),
);
